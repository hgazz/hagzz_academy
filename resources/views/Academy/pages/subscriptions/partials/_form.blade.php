@csrf
<div class="card">
    <div class="card-header"><h3 class="mb-0">{{ isset($subscription) ? 'Edit Subscription' : 'Add Subscription' }}</h3></div>
    <div class="card-body">
        <div class="row">
    ...
    <div class="card-footer">
        ...
        <a href="{{ route('academy.subscriptions.index') }}" class="btn btn-light">Cancel</a>
    </div>
</div>
