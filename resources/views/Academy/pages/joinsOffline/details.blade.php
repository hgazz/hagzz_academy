                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="home-tab-icon" data-bs-toggle="tab" data-bs-target="#home-tab-icon-pane" type="button" role="tab" aria-controls="home-tab-icon-pane" aria-selected="true">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg> {{ trans('admin.user.main_details') }}
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            ...
                                            <div class="container-fluid mt-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4 mt-2">
                                                        <div class="card">
                                                            <div class="card-header">
                                                                <h5 class="card-title">{{ trans('admin.academies.club_member') }}</h5>
                                                            </div>
                                                            <div class="card-body">
                                                                <p class="card-text text-dark fw-bold">{{$join->user->club_member ?? 'N/A'}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4 mt-2">
