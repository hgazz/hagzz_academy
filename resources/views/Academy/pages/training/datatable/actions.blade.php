<div class="d-inline-flex align-items-center gap-1 flex-wrap">
    ...
    <a href="{{ route('academy.training.createBooking') }}" class="heroui-btn-action" style="background: var(--heroui-success-light); border-color: var(--heroui-success-border); color: #059669;" title="{{ trans('admin.training.booking') }}">
