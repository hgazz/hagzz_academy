            ...
            @unless($isVenueOnly)
                <li class="menu {{ $reportsActive ? 'active' : '' }}">
                    ...
                    <ul class="collapse submenu list-unstyled {{ $reportsActive ? 'show' : '' }}" id="report" data-bs-parent="#accordionExample">
                        ...
                        <li class="menu {{ Request::routeIs('academy.report.transaction.index') ? 'active' : '' }}"><a href="{{ route('academy.report.transaction.index') }}" class="dropdown-toggle"><div><i class="fa-solid fa-money-bill-transfer menu-icon"></i><span>{{ trans('admin.transaction') }}</span></div></a></li>
                        <li class="menu {{ Request::routeIs('academy.report.joins') ? 'active' : '' }}"><a href="{{ route('academy.report.joins') }}" class="dropdown-toggle"><div><i class="fa-solid fa-ticket menu-icon"></i><span>{{ trans('admin.bookings.bookings') }}</span></div></a></li>
                        <li class="menu {{ Request::routeIs('academy.report.offline-joins') ? 'active' : '' }}"><a href="{{ route('academy.report.offline-joins') }}" class="dropdown-toggle"><div><i class="fa-solid fa-cash-register menu-icon"></i><span>{{ trans('admin.bookings.offline_bookings') }}</span></div></a></li>
                        <li class="menu {{ Request::routeIs('academy.report.coach') ? 'active' : '' }}"><a href="{{ route('academy.report.coach') }}" class="dropdown-toggle"><div><i class="fa-solid fa-medal menu-icon"></i><span>{{ trans('admin.Coaches') }}</span></div></a></li>
                    </ul>
                </li>
            @endunless
