...
class InvoicePrintController extends Controller
{
    ...
    public function student(Request $request, AcademyStudentSubscription $subscription)
    {
        ...
        return $this->render($request, [
            ...
            'balance' => $subscription->remaining_amount,
            'currency' => 'EGP',
    ...
    public function platform(Request $request, TenantSubscriptionInvoice $invoice)
    {
        ...
        return $this->render($request, [
            ...
            'seller' => $this->party('Hagzz', null, null, null, null, asset('assetsAdmin/logo/Primary.svg')),
    ...
    private function owns($academyId): void
    {
        abort_unless((int) $academyId === $this->getAcademyId(), 404);
    }
